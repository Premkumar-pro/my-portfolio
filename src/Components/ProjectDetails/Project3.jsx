    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          {/* Live Demo Button */}
          <motion.a
            href="https://your-live-demo-link-3.com"
            target="_blank"
        ...
        >
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg text-gray-600 mb-8">
              <p>
                An interactive data visualization dashboard built with FastAPI backend and React frontend.
                This project processes large datasets and presents them through intuitive charts and graphs
                with filtering options and data export capabilities.
              </p>
              
              <p>
                The dashboard features real-time data updates, multiple chart types, and responsive design
                that works seamlessly across all devices. It includes user authentication and role-based access control.
              </p>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Data export capabilities (CSV, JSON, Excel)</li>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="bg-blue-100 text-blue-700 text-sm px-3 py-1 rounded-full">Chart.js</span>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="bg-green-100 text-green-700 text-sm px-3 py-1 rounded-full">FastAPI</span>
                    <span className="bg-green-100 text-green-700 text-sm px-3 py-1 rounded-full">Pandas</span>
                    <span className="bg-green-100 text-green-700 text-sm px-3 py-1 rounded-full">Plotly</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-purple-100 text-purple-700 text-sm px-3 py-1 rounded-full">PostgreSQL</span>
                    <span className="bg-purple-100 text-purple-700 text-sm px-3 py-1 rounded-full">Redis</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800">2.5 Months</span>
                  </div>
                  <div className="flex justify-between">
